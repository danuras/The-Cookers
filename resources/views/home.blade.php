        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/bakso.jpeg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/iages/mieayam.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/nasgor.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/mieayambakso.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/lele.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/tehobeng.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/juspukat.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card border">
                        <img
                            src="{{asset ('images/images/esjeruk.jpg')}}"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
