...
<body>
    ...
    <center>
        <!-- Tombol Sebelumnya -->
        <a class="button" type="submit" href="{{route('recipes.upload-recipe-atribute')}}" style="text-decoration: none;">Sebelumnya</a>
        <!-- Tombol Selanjutnya -->

        <a class="button" type="submit" href="{{route('recipes.finish-upload-recipe')}}" style="text-decoration: none;">Kirim</a>
    </center>
  </div>
    <br>
