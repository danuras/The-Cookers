...
<html>
<head>
    <title>Edit Atribut Resep</title>
...
<body>
        <div class="container">
            ...
            <div class="form-container">
              <form  method="POST" enctype="multipart/form-data" action="{{route('save.recipes.edit-recipe-atribute')}}">
                @method("POST")
                @csrf
                ...
                <textarea id="bahan" name="ingredients" rows="4" required>{{session('r_ingredients')}}</textarea>
                ...
                <textarea id="langkah_masak" style = "white-space: pre-wrap;
" name="steps"  rows="4" required>{{session('r_steps')}}</textarea>
                ...
                <center>
                    <!-- Tombol Sebelumnya -->
                    <a class="button"  href="{{ route('recipes.edit-image', ['recipe' => session('recipe_id_r')]) }}" style="text-decoration: none;">Sebelumnya</a>
                    <!-- Tombol Selanjutnya -->
