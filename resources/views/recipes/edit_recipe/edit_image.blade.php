...
<body>
    ...
    <center>
        <!-- Tombol Sebelumnya -->
        <a class="button" type="submit" href="/recipes/user-recipe" style="text-decoration: none;">Sebelumnya</a>
        <!-- Tombol Selanjutnya -->
        <form  action = "{{route('save.recipes.edit-image')}}" method = "POST" style = "display: inline-block; vertical-align: middle;" enctype="multipart/form-data">
            @method("POST")
            @csrf
